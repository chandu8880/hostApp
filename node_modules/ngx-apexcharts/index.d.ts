...
declare class ChartComponent implements OnChanges, OnDestroy {
    ...
    readonly chartElement: ElementRef;
    private chartObj?;
...
declare class NgxApexchartsDirective implements OnChanges {
    private el;
    private readonly ngZone;
    chart: ApexChart;
    annotations: ApexAnnotations;
...
declare class NgxApexchartsModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<NgxApexchartsModule, never, [typeof ChartComponent, typeof NgxApexchartsDirective], [typeof ChartComponent, typeof NgxApexchartsDirective]>;
